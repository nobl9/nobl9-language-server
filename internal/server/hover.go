...
func newDocsHoverProvider(docs docsProvider) *docsHoverProvider {
	return &docsHoverProvider{docs: docs}
}

type docsHoverProvider struct {
	docs docsProvider
}

func (d docsHoverProvider) Hover(kind manifest.Kind, path string) *messages.HoverResponse {
...
func (d docsHoverProvider) buildDocs(doc *sdkdocs.PropertyDoc) string {
	b := strings.Builder{}
